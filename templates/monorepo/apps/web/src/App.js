...
function ChainSwitcher() {
    ...
    return (_jsxs("label", { className: "chain-switcher", children: [_jsx("span", { className: "chain-switcher__label", children: "Chain" }), _jsxs("div", { className: "chain-switcher__control", children: [_jsx("span", { children: availableChains.find((item) => item.key === chainKey)?.name ?? chainKey }), _jsx("select", { value: chainKey, onChange: handleChange, "aria-label": "Select chain", children: availableChains.map((chain) => (_jsx("option", { value: chain.key, children: chain.name }, chain.key))) }), _jsx("svg", { viewBox: "0 0 20 20", className: "chain-switcher__icon", "aria-hidden": "true", children: _jsx("path", { d: "M5.25 7.5 10 12.5l4.75-5", stroke: "currentColor", strokeWidth: "1.5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }) })] })] }));
}
